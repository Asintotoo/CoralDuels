...
import com.asintoto.coralduels.enums.ButtonType;
...
public class Button {
    ...
    public Button(ItemStack item, ButtonType buttonType) {
        ...
        if(this.buttonType == ButtonType.CLOSE) {
            ...
            meta.getPersistentDataContainer().set(Keys.BUTTON_TYPE_CLOSE,
            ...
            meta.getPersistentDataContainer().set(Keys.BUTTON_TYPE_UNLOCKED,
                    PersistentDataType.BOOLEAN, true);
            ...
            meta.getPersistentDataContainer().set(Keys.BUTTON_TYPE_PREV,
                    PersistentDataType.BOOLEAN, true);
